...
function createArray(...elements) {
  ...
  if (elements.length > 0) {
    ...
    console.error("Помилка: Не вказано жодного елементу.");
    return [];
  }
}
...
function combineAndReverseArrays(arr1, arr2) {
  ...
  if (!Array.isArray(arr1) || !Array.isArray(arr2)) {
    console.error("Помилка: Обидва аргументи мають бути масивами.");
    return [];
  }
...
function customFill(arr, value, start = 0, end = arr.length) {
  ...
  if (!Array.isArray(arr) || start < 0 || end < 0 || start > arr.length || end > arr.length) return false;
...
function customIncludes(arr, element) {
  ...
  console.log(`Елемент ${element} зустрічається в масиві ${count} раз(ів).`);
